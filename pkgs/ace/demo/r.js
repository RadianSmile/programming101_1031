...
<head>
    <title>Editor</title>
    <link rel="stylesheet" href="../../../ace/kitchen-sink/styles.css" type="text/css" media="screen" charset="utf-8">    
</head>
<body>
    <div id="optionsPanel" style="position:absolute;height:100%;width:260px">
        <a href="http://c9.io" title="Cloud9 IDE | Your code anywhere, anytime">
            <img id="c9-logo" src="../../../ace/kitchen-sink/logo.png" style="width: 172px;margin: -9px 30px -12px 51px;">
        </a>
    </div>
    ...
    <script src="../../../ace/demo/packed.js" data-ace-base="src" type="text/javascript" charset="utf-8"></script>  
