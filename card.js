        ...
        query.find({
            success: function(data){
                    ...
                    for(var i = 0; i<data.length; i++){
                        ...
                        if(card == undefined){
                            var backcard = "<div class='card-box col-md-2' data-toggle='tooltip' data-placement='top' title='你有一張抽卡機會'><a href='card_drawing.html'><img id='backcard' src='img/choosecard/back.png' alt='alternative text' title='你有一張抽卡機會'></a></div>"; // Rn
